...
public class AbsEx2 {
	...
	public static void main(String[] args) {
		Manager m1=new Manager("Hema", 1, 60000, 10);
		Developer d1=new Developer("Mayu", 2, 55000, "Java");
		Developer d2=new Developer("Nithya", 3, 50000, "python");
		Developer d3=new Developer("Dharani", 4, 60000, ".Net");
